...
> **Como usar este arquivo:** cole o conteúdo abaixo como **primeira mensagem** para o Claude Code na pasta do projeto, **ou** salve como `CLAUDE.md` na raiz (o Claude Code carrega esse arquivo automaticamente como contexto persistente). Antes de qualquer código, o Claude Code deve seguir o **Workflow obrigatório** da seção 5.
